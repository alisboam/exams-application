...
An application to manage laboratory exams. This project is in Portuguese [pt-br] and is part of Rebase Labs course, sponsored by Rebase and Campus Code. Current progress available at: Trello - Rebase Labs Card

Uma app web para listagem de exames médicos. Este projeto é parte do curso Rebase Labs, patrocinado por Rebase e Campus Code. Acompanhamento do progresso disponível em: Trello - Rebase Labs Card
...
apagar todos os containers e excluir os volumes
